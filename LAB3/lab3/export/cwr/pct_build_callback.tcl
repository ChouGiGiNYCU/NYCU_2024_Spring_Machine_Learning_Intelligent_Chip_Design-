::namespace eval ::pct::build {
  ...
  proc callback {args} {
    ...
    [namespace current]::add_vppack_path "[::subst -nobackslashes -nocommands {/RAID2/COURSE/mlchip/mlchip038/lab3/export/parameters/HARDWARE.unevald.parameters}]" "[::subst -nobackslashes -nocommands {simulation/parameters}]"
  }
